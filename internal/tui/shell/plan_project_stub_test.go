...
func TestPlanProjectStub_BTriggersPop(t *testing.T) {
	s := newPlanProjectStub("alpha", "proj-1")
...
func TestPlanProjectStub_EscTriggersPop(t *testing.T) {
	s := newPlanProjectStub("alpha", "proj-1")
...
func TestPlanProjectStub_UnrelatedKeyIsNoop(t *testing.T) {
	s := newPlanProjectStub("alpha", "proj-1")
...
func TestPlanProjectStub_TitleAndStatusKeysExposeBack(t *testing.T) {
	s := newPlanProjectStub("alpha", "proj-1")

	if got := s.Title(); got != "Plan Project" {
		t.Errorf("Title() = %q, want Plan Project", got)
	}
	keys := s.StatusKeys()
	if len(keys) != 1 {
...
func TestPlanProjectStub_BodyIncludesProfileAndProjectIDs(t *testing.T) {
...
var _ Screen = (*planProjectStub)(nil)
